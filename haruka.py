...
#--------------------------------------------------------
                ...
                cl.sendMessage(msg)
		cl.sendText(msg.to,"Tebak itu sp?")
#--------------------------------------------------------
...
#	      if msg.from_ in Creator:
                if msg.to in cctv['point']:
                    ...
                    cl.sendText(msg.to, "Set dulu asw")                         
...
#--------------------------------------------------------
		...
		if msg.from_ in Creator:
		    ...
		    cl.sendText(msg.to,"Jgn usir aq kk :(")
#--------------------------------------------------------
...
#----------------------------------------------------------
            ...
            elif msg.text.lower() in ["bot","phing","phingg","oy","woy"]:
...
#-------------------CRASH--------------------------------
              ...
              if msg.from_ in Creator:
                msg.contentType = 13
                msg.contentMetadata = {'mid': "GEVAKUN,'"}
                cl.sendMessage(msg)
...
#--------------------------------------------------------
              ...
              if wait["Tag"] == True:
                tanya = msg.text.replace("@􀐂Geva","")
                jawab = ("Klo penting, pc dia aja wkwk")
...
#       if msg.from_ in admin:
                ...
                kk.sendText(msg.to,"Apa elo tega???")
                cl.sendText(msg.to,"Zzzzzz")
                ki.sendText(msg.to,"Ngantoook")
                kk.sendText(msg.to,"Tidur ah..")
#--------------------------------------------------------
